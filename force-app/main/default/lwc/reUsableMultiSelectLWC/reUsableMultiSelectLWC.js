...
import getListOfSObject from '@salesforce/apex/StudentSearchController.getListOfSObject'
const MINIMAL_SEARCH_TERM_LENGTH = 2; // Min number of chars required to search
const SEARCH_DELAY = 300; // Wait 300 ms after user stops typing then, peform search

export default class ReUsableMultiSelectLWC extends LightningElement {
...
// EVENT HANDLING
    ...
    handleLoad(){
        getListOfSObject(this.hasSelection()).then(result => {
